...
- [Determining if an integer is a power of 2](BitHacks.md/#determining-if-an-integer-is-a-power-of-2)
- Sign extending
 - [Sign extending from a constant bit-width](BitHacks.md/#sign-extending-from-a-constant-bit-width)
 - [Sign extending from a variable bit-width](BitHacks.md/#sign-extending-from-a-variable-bit-width)
 - [Sign extending from a variable bit-width in 3 operations](BitHacks.md/#sign-extending-from-a-variable-bit-width-in-3-operations)
- [Conditionally set or clear bits without branching](BitHacks.md/#conditionally-set-or-clear-bits-without-branching)
- [Conditionally negate a value without branching](BitHacks.md/#conditionally-negate-a-value-without-branching)
- [Merge bits from two values according to a mask](BitHacks.md/#merge-bits-from-two-values-according-to-a-mask)
- Counting bits set
 - [Counting bits set, naive way](BitHacks.md/#counting-bits-set-naive-way)
 - [Counting bits set by lookup table](BitHacks.md/#counting-bits-set-by-lookup-table)
 - [Counting bits set, Brian Kernighan's way](BitHacks.md/#counting-bits-set-brian-kernighans-way)
 - [Counting bits set in 14, 24, or 32-bit words using 64-bit instructions](BitHacks.md/#counting-bits-set-in-14-24-or-32-bit-words-using-64-bit-instructions)
 - [Counting bits set, in parallel](BitHacks.md/#counting-bits-set-in-parallel)
 - [Count bits set (rank) from the most-significant bit upto a given position](BitHacks.md/#count-bits-set-rank-from-the-most-significant-bit-upto-a-given-position)
 - [Select the bit position (from the most-significant bit) with the given count (rank)](BitHacks.md/#select-the-bit-position-from-the-most-significant-bit-with-the-given-count-rank)
- Computing parity (1 if an odd number of bits set, 0 otherwise)
 - [Compute parity of a word the naive way](BitHacks.md/#computing-parity-the-naive-way)
 - [Compute parity by lookup table](BitHacks.md/#compute-parity-by-lookup-table)
 - [Compute parity of a byte using 64-bit multiply and modulus division](BitHacks.md/#compute-parity-of-a-byte-using-64-bit-multiply-and-modulus-division)
 - [Compute parity of word with a multiply](BitHacks.md/#compute-parity-of-word-with-a-multiply)
 - [Compute parity in parallel](BitHacks.md/#compute-parity-in-parallel)
- Swapping Values
 - [Swapping values with subtraction and addition](BitHacks.md/#swapping-values-with-subtraction-and-addition)
 - [Swapping values with XOR](BitHacks.md/#swapping-values-with-xor)
 - [Swapping individual bits with XOR](BitHacks.md/#swapping-individual-bits-with-xor)
- Reversing bit sequences
 - [Reverse bits the obvious way](BitHacks.md/#reverse-bits-the-obvious-way)
 - [Reverse bits in word by lookup table](BitHacks.md/#reverse-bits-in-word-by-lookup-table)
 - [Reverse the bits in a byte with 3 operations (64-bit multiply and modulus division)](BitHacks.md/#reverse-the-bits-in-a-byte-with-3-operations-64-bit-multiply-and-modulus-division)
 - [Reverse the bits in a byte with 4 operations (64-bit multiply, no division)](BitHacks.md/#reverse-the-bits-in-a-byte-with-4-operations-64-bit-multiply-no-division)
 - [Reverse the bits in a byte with 7 operations (no 64-bit, only 32)](BitHacks.md/#reverse-the-bits-in-a-byte-with-7-operations-no-64-bit)
 - [Reverse an N-bit quantity in parallel with 5 * lg(N) operations](BitHacks.md/#reverse-an-n-bit-quantity-in-parallel-in-5--lgn-operations)
- Modulus division (aka computing remainders)
 - [Computing modulus division by 1 << s without a division operation (obvious)](BitHacks.md/#compute-modulus-division-by-1--s-without-a-division-operator)
 - [Computing modulus division by (1 << s) - 1 without a division operation](BitHacks.md/#compute-modulus-division-by-1--s---1-without-a-division-operator)
 - [Computing modulus division by (1 << s) - 1 in parallel without a division operation](BitHacks.md/#compute-modulus-division-by-1--s---1-in-parallel-without-a-division-operator)
- Finding integer log base 2 of an integer (aka the position of the highest bit set)
 - [Find the log base 2 of an integer with the MSB N set in O(N) operations (the obvious way)](BitHacks.md/#find-the-log-base-2-of-an-integer-with-the-msb-n-set-in-on-operations-the-obvious-way)
 - [Find the integer log base 2 of an integer with an 64-bit IEEE float](BitHacks.md/#find-the-integer-log-base-2-of-an-integer-with-an-64-bit-ieee-float)
 - [Find the log base 2 of an integer with a lookup table](BitHacks.md/#find-the-log-base-2-of-an-integer-with-a-lookup-table)
 - [Find the log base 2 of an N-bit integer in O(lg(N)) operations](BitHacks.md/#find-the-log-base-2-of-an-n-bit-integer-in-olgn-operations)
 - [Find the log base 2 of an N-bit integer in O(lg(N)) operations with multiply and lookup](BitHacks.md/#find-the-log-base-2-of-an-n-bit-integer-in-olgn-operations-with-multiply-and-lookup)
- [Find integer log base 10 of an integer](BitHacks.md/#find-integer-log-base-10-of-an-integer)
- [Find integer log base 10 of an integer the obvious way](BitHacks.md/#find-integer-log-base-10-of-an-integer-the-obvious-way)
- [Find integer log base 2 of a 32-bit IEEE float](BitHacks.md/#find-integer-log-base-2-of-a-32-bit-ieee-float)
- [Find integer log base 2 of the pow(2, r)-root of a 32-bit IEEE float (for unsigned integer r)](BitHacks.md/#find-integer-log-base-2-of-the-pow2-r-root-of-a-32-bit-ieee-float-for-unsigned-integer-r)
- Counting consecutive trailing zero bits (or finding bit indices)
 - [Count the consecutive zero bits (trailing) on the right linearly](BitHacks.md/#count-the-consecutive-zero-bits-trailing-on-the-right-linearly)
 - [Count the consecutive zero bits (trailing) on the right in parallel](BitHacks.md/#count-the-consecutive-zero-bits-trailing-on-the-right-in-parallel)
 - [Count the consecutive zero bits (trailing) on the right by binary search](BitHacks.md/#count-the-consecutive-zero-bits-trailing-on-the-right-by-binary-search)
 - [Count the consecutive zero bits (trailing) on the right by casting to a float](BitHacks.md/#count-the-consecutive-zero-bits-trailing-on-the-right-by-casting-to-a-float)
 - [Count the consecutive zero bits (trailing) on the right with modulus division and lookup](BitHacks.md/#count-the-consecutive-zero-bits-trailing-on-the-right-with-modulus-division-and-lookup)
 - [Count the consecutive zero bits (trailing) on the right with multiply and lookup](BitHacks.md/#count-the-consecutive-zero-bits-trailing-on-the-right-with-multiply-and-lookup)
- [Round up to the next highest power of 2 by float casting](BitHacks.md/#round-up-to-the-next-highest-power-of-2-by-float-casting)
- [Round up to the next highest power of 2](BitHacks.md/#round-up-to-the-next-highest-power-of-2)
- Interleaving bits (aka computing Morton Numbers)
 - [Interleave bits the obvious way](BitHacks.md/#interleave-bits-the-obvious-way)
 - [Interleave bits by table lookup](BitHacks.md/#interleave-bits-by-table-lookup)
 - [Interleave bits with 64-bit multiply](BitHacks.md/#interleave-bits-with-64-bit-multiply)
 - [Interleave bits by Binary Magic Numbers](BitHacks.md/#interleave-bits-by-binary-magic-numbers)
- Testing for ranges of bytes in a word (and counting occurances found)
 - [Determine if a word has a zero byte](BitHacks.md/#determine-if-a-word-has-a-zero-byte)
 - [Determine if a word has a byte equal to n](BitHacks.md/#determine-if-a-word-has-a-byte-equal-to-n)
 - [Determine if a word has byte less than n](BitHacks.md/#determine-if-a-word-has-a-byte-less-than-n)
 - [Determine if a word has a byte greater than n](BitHacks.md/#determine-if-a-word-has-a-byte-greater-than-n)
 - [Determine if a word has a byte between m and n](BitHacks.md/#determine-if-a-word-has-a-byte-between-m-and-n)
- [Compute the lexicographically next bit permutation](BitHacks.md/#compute-the-lexicographically-next-bit-permutation)
